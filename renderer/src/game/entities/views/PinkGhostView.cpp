...
namespace renderer {
    void PinkGhostView::update(logic::GhostModel &subject) {
    ...
    bool PinkGhostView::isMarkedForRemoval() {
        return markedForRemoval;
    }

    void PinkGhostView::markForRemoval() {
        markedForRemoval = true;
    }

    void PinkGhostView::setSize(const logic::Size &size) {
    ...
    void PinkGhostView::updateAnimation() {
        switch (direction) {
    ...
    void PinkGhostView::setDirection(logic::Direction direction) {
