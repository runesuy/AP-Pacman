...
There is no rule in the spacing of the sprites in the spritemap, since selection of the actual sprite box is done via
coordinates in the config.json file.

## config.json

In the **sprites** section of the config.json file, each in-game is assigned to a rectangle inside the spritemap.png
file.
